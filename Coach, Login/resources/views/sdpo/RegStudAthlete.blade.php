...
<body>
    ...
    <div class="search-wrapper">
        <input type="text" id="coachSearch" placeholder="🔍 Search athletes by name, sport, or coach">
    </div>
            ...
            <tbody>
                @foreach ($athletes as $athlete)
                    <tr>
                        <td>{{ $athlete->name }}</td>
                        <td>{{ $athlete->sport }}</td>
                        <td>{{ $athlete->coach->name ?? 'N/A' }}</td>
                        <td><a href="{{ url('/sdpo/view-athlete/' . $athlete->id) }}" class="action-view">View</a></td>
                    </tr>
                @endforeach
            </tbody>
        </table>
